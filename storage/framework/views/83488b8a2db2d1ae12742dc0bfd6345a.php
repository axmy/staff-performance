    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100">
            <div class="p-6">
                ...
                <div class="mt-5 flex items-center gap-3">
                    <a href="<?php echo e(route('reports.staff-performance')); ?>"
                    ...
                    <a href="<?php echo e(route('reports.export.staff-performance', ['year' => now()->year])); ?>"
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100">
            <div class="p-6">
                ...
                <div class="mt-5 flex items-center gap-3">
                    <a href="<?php echo e(route('reports.attendance-summary')); ?>"
                       class="px-6 py-3 rounded-lg font-semibold border border-gray-300 bg-white hover:bg-gray-50 transition-all duration-200 text-gray-700 text-sm">
                        View Report
                    </a>
                    <a href="<?php echo e(route('reports.export.attendance-summary', ['year' => now()->year, 'month' => now()->month])); ?>"
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100">
            <div class="p-6">
                ...
                <div class="mt-5 flex items-center gap-3">
                    <a href="<?php echo e(route('reports.training-summary')); ?>"
                       class="px-6 py-3 rounded-lg font-semibold border border-gray-300 bg-white hover:bg-gray-50 transition-all duration-200 text-gray-700 text-sm">
                        View Report
                    </a>
                    <a href="<?php echo e(route('reports.export.training-summary', ['year' => now()->year])); ?>"
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100">
            <div class="p-6">
                ...
                <div class="mt-5 flex items-center gap-3">
                    <a href="<?php echo e(route('reports.action-report')); ?>"
                       class="px-6 py-3 rounded-lg font-semibold border border-gray-300 bg-white hover:bg-gray-50 transition-all duration-200 text-gray-700 text-sm">
                        View Report
                    </a>
                    <a href="<?php echo e(route('reports.export.action-report', ['year' => now()->year])); ?>"
...
<?php endif; ?>
<?php /**PATH /Users/axmeen/Projects/staff-performance/resources/views/reports/index.blade.php ENDPATH**/ ?>