...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Create Action <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white shadow-sm rounded-xl border border-gray-100">
        <div class="px-4 py-5 sm:p-6">
            ...
            <form method="POST" action="<?php echo e(route('actions.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.select','data' => ['name' => 'staff_id','label' => 'Staff Member','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'staff_id','label' => 'Staff Member','required' => true]); ?>
                        ...
                        <option value="<?php echo e($member->id); ?>" <?php if(old('staff_id') == $member->id): ?> selected <?php endif; ?>>
                            <?php echo e($member->name); ?> (<?php echo e($member->record_card_number); ?>)
                        </option>
...
<?php $component->withAttributes(['name' => 'action_type_id','label' => 'Action Type','required' => true]); ?>
                        ...
                        <option value="<?php echo e($type->id); ?>" <?php if(old('action_type_id') == $type->id): ?> selected <?php endif; ?>>
...
<?php $component->withAttributes(['name' => 'year','label' => 'Year','required' => true]); ?>
                        ...
                        <option value="<?php echo e($y); ?>" <?php if(old('year', date('Y')) == $y): ?> selected <?php endif; ?>><?php echo e($y); ?></option>
...
<?php $component->withAttributes(['name' => 'month','label' => 'Month','required' => true]); ?>
                        ...
                        <option value="<?php echo e($m); ?>" <?php if(old('month', date('n')) == $m): ?> selected <?php endif; ?>>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.date-input','data' => ['name' => 'due_date','label' => 'Due Date','value' => old('due_date')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'due_date','label' => 'Due Date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('due_date'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal8cee41e4af1fe2df52d1d5acd06eed36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8cee41e4af1fe2df52d1d5acd06eed36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.select','data' => ['name' => 'assigned_to','label' => 'Assigned To']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'assigned_to','label' => 'Assigned To']); ?>
                        <option value="">Select a user</option>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($user->id); ?>" <?php if(old('assigned_to') == $user->id): ?> selected <?php endif; ?>>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.textarea','data' => ['name' => 'notes','label' => 'Notes','value' => old('notes'),'rows' => '4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'notes','label' => 'Notes','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('notes')),'rows' => '4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/axmeen/Projects/staff-performance/resources/views/actions/create.blade.php ENDPATH**/ ?>